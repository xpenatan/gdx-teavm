...
public class CustomSourcePrinter {
    ...
    CustomSourcePrinter(final PrettyPrinterConfiguration configuration) {
        this(configuration.getIndentation(), configuration.getEndOfLineCharacter());
    }

    CustomSourcePrinter(final PrinterConfiguration configuration) {
    ...
    CustomSourcePrinter(Indentation indentation, String eol) {
     ...
     */
    public CustomSourcePrinter indent() {
     ...
     * Does not actually output anything.
     */
    public CustomSourcePrinter indentWithAlignTo(int column) {
     ...
     * Does not actually output anything.
     */
    public CustomSourcePrinter unindent() {
        if(indents.isEmpty()) {
     ...
     * @see com.github.javaparser.printer.SourcePrinter#println(String)
     */
    public CustomSourcePrinter print(final String arg) {
        if(!indented) {
     ...
     * @return this instance, for nesting calls to method as fluent interface
     */
    public CustomSourcePrinter println(final String arg) {
        print(arg);
        println();
        return this;
    }
     ...
     * @return this instance, for nesting calls to method as fluent interface
     */
    public CustomSourcePrinter println() {
