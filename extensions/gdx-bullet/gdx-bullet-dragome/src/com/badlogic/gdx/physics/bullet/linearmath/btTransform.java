...
public class btTransform extends BulletBase {
	...
	protected void cacheObj() {
		com.dragome.commons.javascript.ScriptHelper.evalNoResult("this.$$$jsObj=Bullet.wrapPointer(this.$$$cPointer,Bullet.btTransform);",this);
	}

    @Override
    protected void delete() {
		long addr = cPointer;
		com.dragome.commons.javascript.ScriptHelper.evalNoResult("var mat=Bullet.wrapPointer(addr,Bullet.btTransform);Bullet.destroy(mat);",this);
    }

    public static void set(btTransform tra, float[] value) {
		tra.checkPointer();
		Object transform = tra.jsObj;
    ...
    public static void get(btTransform tra, float[] value) {
		tra.checkPointer();
		Object transform = tra.jsObj;
		getOpenGLMatrix(transform, value);
    }
