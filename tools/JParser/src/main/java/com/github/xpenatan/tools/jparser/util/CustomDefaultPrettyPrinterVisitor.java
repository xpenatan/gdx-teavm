...
public class CustomDefaultPrettyPrinterVisitor implements VoidVisitor<Void> {
    protected final PrinterConfiguration configuration;
    protected final CustomSourcePrinter printer;

    public CustomDefaultPrettyPrinterVisitor(PrinterConfiguration configuration, CustomSourcePrinter printer) {
