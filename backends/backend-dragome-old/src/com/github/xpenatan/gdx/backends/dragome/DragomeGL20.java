...
public class DragomeGL20 implements GL20 {
    ...
    public void glCompressedTexImage2D(int target, int level, int internalformat, int width, int height, int border,
        ...
        throw new GdxRuntimeException("compressed textures not supported by Dragome WebGL backend");
    }
    ...
    public void glGetIntegerv(int pname, IntBuffer params) {
        if(pname == GL20.GL_ACTIVE_TEXTURE || pname == GL20.GL_ALPHA_BITS || pname == GL20.GL_BLEND_DST_ALPHA
            ...
            ScriptHelper.put("context", gl, this);
            ScriptHelper.put("pname", pname, this);
            int evalInt = ScriptHelper.evalInt("context.node.getParameter(pname)", this);
            params.put(0, evalInt);
        }
        else
    ...
    public String glGetString(int name) {
        String parameter = (String)gl.getParameter(name);
        return parameter;
    }
...
//	gl.texImage2D(target, level, internalformat, width, height, border, format, type, buffer);
    ...
    public void glGetBooleanv(int pname, Buffer params) {
        throw new GdxRuntimeException("glGetBoolean not supported by Dragome WebGL backend");
    }
    ...
    public void glGetFloatv(int pname, FloatBuffer params) {
        if(pname == GL20.GL_DEPTH_CLEAR_VALUE || pname == GL20.GL_LINE_WIDTH || pname == GL20.GL_POLYGON_OFFSET_FACTOR
            ...
            ScriptHelper.put("context", gl, this);
            ScriptHelper.put("pname", pname, this);
            float result = ScriptHelper.evalFloat("context.node.getParameter(pname);", this);
            params.put(0, result);
        }
        else
            throw new GdxRuntimeException("glGetFloat not supported by Dragome WebGL backend");
    ...
    public void glGetProgramiv(int program, int pname, IntBuffer params) {
        if(pname == GL20.GL_DELETE_STATUS || pname == GL20.GL_LINK_STATUS || pname == GL20.GL_VALIDATE_STATUS) {
            ...
            ScriptHelper.put("pname", pname, this);
            boolean result = ScriptHelper.evalBoolean("context.node.getProgramParameter(program.node, pname);", this);
    ...
    public void glGetShaderiv(int shader, int pname, IntBuffer params) {
        if(pname == GL20.GL_COMPILE_STATUS || pname == GL20.GL_DELETE_STATUS) {
            ScriptHelper.put("context", gl, this);
            ScriptHelper.put("shader", shaders.get(shader), this);
            ScriptHelper.put("pname", pname, this);
            boolean result = ScriptHelper.evalBoolean("context.node.getShaderParameter(shader.node, pname);", this);
            params.put(result ? GL20.GL_TRUE : GL20.GL_FALSE);
        }
        else {
            ScriptHelper.put("context", gl, this);
            ScriptHelper.put("shader", shaders.get(shader), this);
            ScriptHelper.put("pname", pname, this);
            int result = ScriptHelper.evalInt("context.node.getShaderParameter(shader.node, pname);", this);
            params.put(result);
        }
    }
    ...
    public void glGetShaderPrecisionFormat(int shadertype, int precisiontype, IntBuffer range, IntBuffer precision) {
        throw new GdxRuntimeException("glGetShaderPrecisionFormat not supported by Dragome WebGL backend");
    }

    @Override
    public void glGetTexParameterfv(int target, int pname, FloatBuffer params) {
        throw new GdxRuntimeException("glGetTexParameter not supported by Dragome WebGL backend");
    }
    ...
    public void glGetVertexAttribPointerv(int index, int pname, Buffer pointer) {
        throw new GdxRuntimeException("glGetVertexAttribPointer not supported by Dragome WebGL backend");
    }
    ...
    public void glShaderBinary(int n, IntBuffer shaders, int binaryformat, Buffer binary, int length) {
        throw new GdxRuntimeException("glShaderBinary not supported by Dragome WebGL backend");
    }
...
//		gl.uniformMatrix2fv(loc, transpose, value);
    ...
    public void glUniformMatrix3fv(int location, int count, boolean transpose, float[] value, int offset) {
        ...
        else {     //TODO check if loc is null
