...
import com.github.xpenatan.gdx.teavm.backends.web.filesystem.FileDB;
import com.github.xpenatan.gdx.teavm.backends.web.filesystem.MemoryFileStorage;
import com.github.xpenatan.gdx.teavm.backends.web.filesystem.types.ClasspathStorage;
import com.github.xpenatan.gdx.teavm.backends.web.filesystem.types.InternalStorage;
import com.github.xpenatan.gdx.teavm.backends.web.filesystem.types.LocalDBStorage;
...
public class WebFiles implements Files {
    ...
    public WebFiles(WebApplicationConfiguration config, WebApplication teaApplication) {
    ...
    public FileHandle classpath(String path) {
        return new WebFileHandle(this, path, FileType.Classpath);
    }

    @Override
    public FileHandle internal(String path) {
        return new WebFileHandle(this, path, FileType.Internal);
    }

    @Override
    public FileHandle local(String path) {
        return new WebFileHandle(this, path, FileType.Local);
    }
