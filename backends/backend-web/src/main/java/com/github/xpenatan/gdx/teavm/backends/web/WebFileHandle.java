...
public class WebFileHandle extends FileHandle {
    ...
    public WebFileHandle(WebFiles teaFiles, String fileName, FileType type) {
    ...
    public FileHandle child(String name) {
        return new WebFileHandle(teaFiles, (file.isEmpty() ? "" : (file + (file.endsWith("/") ? "" : "/"))) + name,
                type);
    }
    ...
    public FileHandle parent() {
        ...
        return new WebFileHandle(teaFiles, dir, type);
    }
    ...
    public void moveTo(FileHandle dest) {
        ...
        if(!dest.exists()) {
            ...
            if(thisParent.equals(destParent)) {
                ...
                teaFiles.getFileDB(type).rename(this, (WebFileHandle)dest);
                return;
            }
        }
