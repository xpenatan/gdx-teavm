 ...
 * @author xpenatan
 */
public abstract class WebGraphics implements Graphics {
    ...
    public Cursor newCursor(Pixmap pixmap, int xHotspot, int yHotspot) {
        return new WebCursor(pixmap, xHotspot, yHotspot);
    }

    @Override
    public void setCursor(Cursor cursor) {
      canvas.getStyle().setProperty("cursor", ((WebCursor)cursor).cssCursorProperty);
    }

    @Override
    public void setSystemCursor(SystemCursor systemCursor) {
      canvas.getStyle().setProperty("cursor", WebCursor.getNameForSystemCursor(systemCursor));
    }
