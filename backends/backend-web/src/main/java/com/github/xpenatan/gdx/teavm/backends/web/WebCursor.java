...
import com.github.xpenatan.gdx.teavm.backends.web.utils.PNG;

/**
 * Cursor functionality ported for libGDX/GWT. This implementation also supports dynamically created cursor
 * images.
 */
public class WebCursor implements Cursor {

  String cssCursorProperty;

  public WebCursor(Pixmap pixmap, int xHotspot, int yHotspot) {
    if (pixmap == null) {
