 ...
 *
 * @since Android 1.0 */
public abstract class XFloatBuffer extends XBuffer implements Comparable<XFloatBuffer> {
     ...
     * @since Android 1.0 */
    public static XFloatBuffer allocate (int capacity) {
        if (capacity < 0) {
     ...
     * @return the created float buffer.
     * @since Android 1.0 */
    public static XFloatBuffer wrap (float[] array) {
     ...
     * @since Android 1.0 */
    public static XFloatBuffer wrap (float[] array, int start, int len) {
        if (array == null) {
        ...
        XFloatBuffer buf = BufferFactory.newFloatBuffer(array);
        buf.position = start;
        buf.limit = start + len;
     ...
     * @since Android 1.0 */
    public abstract XFloatBuffer asReadOnlyBuffer ();
     ...
     * @since Android 1.0 */
    public abstract XFloatBuffer compact ();
     ...
     * @since Android 1.0 */
    public int compareTo (XFloatBuffer otherBuffer) {
     ...
     * @since Android 1.0 */
    public abstract XFloatBuffer duplicate ();
    ...
    public boolean equals (Object other) {
        if (!(other instanceof XFloatBuffer)) {
            return false;
        }
        XFloatBuffer otherBuffer = (XFloatBuffer)other;
     ...
     * @since Android 1.0 */
    public XFloatBuffer get (float[] dest) {
     ...
     * @since Android 1.0 */
    public XFloatBuffer get (float[] dest, int off, int len) {
...
// }
     ...
     * @exception ReadOnlyBufferException if no changes may be made to the contents of this buffer.
     * @since Android 1.0 */
    public abstract XFloatBuffer put (float f);
     ...
     * @exception ReadOnlyBufferException if no changes may be made to the contents of this buffer.
     * @since Android 1.0 */
    public final XFloatBuffer put (float[] src) {
     ...
     * @exception ReadOnlyBufferException if no changes may be made to the contents of this buffer.
     * @since Android 1.0 */
    public XFloatBuffer put (XFloatBuffer src) {
        if (src == this) {
            throw new IllegalArgumentException();
        }
     ...
     * @exception ReadOnlyBufferException if no changes may be made to the contents of this buffer.
     * @since Android 1.0 */
    public abstract XFloatBuffer put (int index, float f);
     ...
     * @since Android 1.0 */
    public abstract XFloatBuffer slice ();
