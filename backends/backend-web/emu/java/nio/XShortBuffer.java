 ...
 *
 * @since Android 1.0 */
public abstract class XShortBuffer extends XBuffer implements Comparable<XShortBuffer> {
     ...
     * @since Android 1.0 */
    public static XShortBuffer allocate (int capacity) {
        if (capacity < 0) {
     ...
     * @return the created short buffer.
     * @since Android 1.0 */
    public static XShortBuffer wrap (short[] array) {
     ...
     * @since Android 1.0 */
    public static XShortBuffer wrap (short[] array, int start, int len) {
        if (array == null) {
        ...
        XShortBuffer buf = BufferFactory.newShortBuffer(array);
        buf.position = start;
        buf.limit = start + len;
     ...
     * @since Android 1.0 */
    public abstract XShortBuffer asReadOnlyBuffer ();
     ...
     * @since Android 1.0 */
    public abstract XShortBuffer compact ();
     ...
     * @since Android 1.0 */
    public int compareTo (XShortBuffer otherBuffer) {
     ...
     * @since Android 1.0 */
    public abstract XShortBuffer duplicate ();
    ...
    public boolean equals (Object other) {
        if (!(other instanceof XShortBuffer)) {
            return false;
        }
        XShortBuffer otherBuffer = (XShortBuffer)other;
     ...
     * @since Android 1.0 */
    public XShortBuffer get (short[] dest) {
     ...
     * @since Android 1.0 */
    public XShortBuffer get (short[] dest, int off, int len) {
     ...
     * @exception ReadOnlyBufferException if no changes may be made to the contents of this buffer.
     * @since Android 1.0 */
    public abstract XShortBuffer put (short s);
     ...
     * @exception ReadOnlyBufferException if no changes may be made to the contents of this buffer.
     * @since Android 1.0 */
    public final XShortBuffer put (short[] src) {
     ...
     * @exception ReadOnlyBufferException if no changes may be made to the contents of this buffer.
     * @since Android 1.0 */
    public XShortBuffer put (XShortBuffer src) {
        if (src == this) {
            throw new IllegalArgumentException();
        }
     ...
     * @exception ReadOnlyBufferException if no changes may be made to the contents of this buffer.
     * @since Android 1.0 */
    public abstract XShortBuffer put (int index, short s);
     ...
     * @since Android 1.0 */
    public abstract XShortBuffer slice ();
