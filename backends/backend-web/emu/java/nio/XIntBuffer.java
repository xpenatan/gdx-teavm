 ...
 *
 * @since Android 1.0 */
public abstract class XIntBuffer extends XBuffer implements Comparable<XIntBuffer> {
     ...
     * @since Android 1.0 */
    public static XIntBuffer allocate (int capacity) {
        if (capacity < 0) {
     ...
     * @return the created int buffer.
     * @since Android 1.0 */
    public static XIntBuffer wrap (int[] array) {
     ...
     * @since Android 1.0 */
    public static XIntBuffer wrap (int[] array, int start, int len) {
        if (array == null) {
        ...
        XIntBuffer buf = BufferFactory.newIntBuffer(array);
        buf.position = start;
        buf.limit = start + len;
     ...
     * @since Android 1.0 */
    public abstract XIntBuffer asReadOnlyBuffer ();
     ...
     * @since Android 1.0 */
    public abstract XIntBuffer compact ();
     ...
     * @since Android 1.0 */
    public int compareTo (XIntBuffer otherBuffer) {
     ...
     * @since Android 1.0 */
    public abstract XIntBuffer duplicate ();
    ...
    public boolean equals (Object other) {
        if (!(other instanceof XIntBuffer)) {
            return false;
        }
        XIntBuffer otherBuffer = (XIntBuffer)other;
     ...
     * @since Android 1.0 */
    public XIntBuffer get (int[] dest) {
     ...
     * @since Android 1.0 */
    public XIntBuffer get (int[] dest, int off, int len) {
     ...
     * @exception ReadOnlyBufferException if no changes may be made to the contents of this buffer.
     * @since Android 1.0 */
    public abstract XIntBuffer put (int i);
     ...
     * @exception ReadOnlyBufferException if no changes may be made to the contents of this buffer.
     * @since Android 1.0 */
    public final XIntBuffer put (int[] src) {
     ...
     * @exception ReadOnlyBufferException if no changes may be made to the contents of this buffer.
     * @since Android 1.0 */
    public XIntBuffer put (XIntBuffer src) {
        if (src == this) {
            throw new IllegalArgumentException();
        }
     ...
     * @exception ReadOnlyBufferException if no changes may be made to the contents of this buffer.
     * @since Android 1.0 */
    public abstract XIntBuffer put (int index, int i);
     ...
     * @since Android 1.0 */
    public abstract XIntBuffer slice ();
