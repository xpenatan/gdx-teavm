 ...
 * </ul>
 * @since Android 1.0 */
public abstract class XByteBuffer extends XBuffer implements Comparable<XByteBuffer> {
     ...
     * @since Android 1.0 */
    public static XByteBuffer allocate (int capacity) {
        if (capacity < 0) {
     ...
     * @throws IllegalArgumentException if {@code capacity < 0}.
     * @since Android 1.0 */
    public static XByteBuffer allocateDirect (int capacity) {
        if (capacity < 0) {
            throw new IllegalArgumentException();
        }
     ...
     * @return the created byte buffer.
     * @since Android 1.0 */
    public static XByteBuffer wrap (byte[] array) {
     ...
     * @since Android 1.0 */
    public static XByteBuffer wrap (byte[] array, int start, int len) {
        int length = array.length;
        if ((start < 0) || (len < 0) || ((long)start + (long)len > length)) {
            throw new IndexOutOfBoundsException();
        }

        XByteBuffer buf = BufferFactory.newByteBuffer(array);
        buf.position = start;
        buf.limit = start + len;
     ...
     * @since Android 1.0 */
    public abstract XCharBuffer asCharBuffer ();
     ...
     * @since Android 1.0 */
    public abstract XDoubleBuffer asDoubleBuffer ();
     ...
     * @since Android 1.0 */
    public abstract XFloatBuffer asFloatBuffer ();
     ...
     * @since Android 1.0 */
    public abstract XIntBuffer asIntBuffer ();
     ...
     * @since Android 1.0 */
    public abstract XLongBuffer asLongBuffer ();
     ...
     * @since Android 1.0 */
    public abstract XByteBuffer asReadOnlyBuffer ();
     ...
     * @since Android 1.0 */
    public abstract XShortBuffer asShortBuffer ();
     ...
     * @since Android 1.0 */
    public abstract XByteBuffer compact ();
     ...
     * @since Android 1.0 */
    public int compareTo (XByteBuffer otherBuffer) {
     ...
     * @since Android 1.0 */
    public abstract XByteBuffer duplicate ();
    ...
    public boolean equals (Object other) {
        if (!(other instanceof XByteBuffer)) {
            return false;
        }
        XByteBuffer otherBuffer = (XByteBuffer)other;
     ...
     * @since Android 1.0 */
    public XByteBuffer get (byte[] dest) {
     ...
     * @since Android 1.0 */
    public XByteBuffer get (byte[] dest, int off, int len) {
     ...
     * @see ByteOrder
     * @since Android 1.0 */
    public final XByteBuffer order (ByteOrder byteOrder) {
        return orderImpl(byteOrder);
    }

    XByteBuffer orderImpl (ByteOrder byteOrder) {
     ...
     * @exception ReadOnlyBufferException if no changes may be made to the contents of this buffer.
     * @since Android 1.0 */
    public abstract XByteBuffer put (byte b);
     ...
     * @exception ReadOnlyBufferException if no changes may be made to the contents of this buffer.
     * @since Android 1.0 */
    public final XByteBuffer put (byte[] src) {
     ...
     * @exception ReadOnlyBufferException if no changes may be made to the contents of this buffer.
     * @since Android 1.0 */
    public XByteBuffer put (XByteBuffer src) {
        if (src == this) {
            throw new IllegalArgumentException();
        }
     ...
     * @exception ReadOnlyBufferException if no changes may be made to the contents of this buffer.
     * @since Android 1.0 */
    public abstract XByteBuffer put (int index, byte b);
     ...
     * @exception ReadOnlyBufferException if no changes may be made to the contents of this buffer.
     * @since Android 1.0 */
    public abstract XByteBuffer putChar (char value);
     ...
     * @exception ReadOnlyBufferException if no changes may be made to the contents of this buffer.
     * @since Android 1.0 */
    public abstract XByteBuffer putChar (int index, char value);
     ...
     * @exception ReadOnlyBufferException if no changes may be made to the contents of this buffer.
     * @since Android 1.0 */
    public abstract XByteBuffer putDouble (double value);
     ...
     * @exception ReadOnlyBufferException if no changes may be made to the contents of this buffer.
     * @since Android 1.0 */
    public abstract XByteBuffer putDouble (int index, double value);
     ...
     * @exception ReadOnlyBufferException if no changes may be made to the contents of this buffer.
     * @since Android 1.0 */
    public abstract XByteBuffer putFloat (float value);
     ...
     * @exception ReadOnlyBufferException if no changes may be made to the contents of this buffer.
     * @since Android 1.0 */
    public abstract XByteBuffer putFloat (int index, float value);
     ...
     * @exception ReadOnlyBufferException if no changes may be made to the contents of this buffer.
     * @since Android 1.0 */
    public abstract XByteBuffer putInt (int value);
     ...
     * @exception ReadOnlyBufferException if no changes may be made to the contents of this buffer.
     * @since Android 1.0 */
    public abstract XByteBuffer putInt (int index, int value);
     ...
     * @exception ReadOnlyBufferException if no changes may be made to the contents of this buffer.
     * @since Android 1.0 */
    public abstract XByteBuffer putLong (long value);
     ...
     * @exception ReadOnlyBufferException if no changes may be made to the contents of this buffer.
     * @since Android 1.0 */
    public abstract XByteBuffer putLong (int index, long value);
     ...
     * @exception ReadOnlyBufferException if no changes may be made to the contents of this buffer.
     * @since Android 1.0 */
    public abstract XByteBuffer putShort (short value);
     ...
     * @exception ReadOnlyBufferException if no changes may be made to the contents of this buffer.
     * @since Android 1.0 */
    public abstract XByteBuffer putShort (int index, short value);
     ...
     * @since Android 1.0 */
    public abstract XByteBuffer slice ();
