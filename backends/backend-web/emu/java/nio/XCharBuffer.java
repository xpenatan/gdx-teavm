 ...
 *
 * @since Android 1.0 */
public abstract class XCharBuffer extends XBuffer implements Comparable<XCharBuffer>, CharSequence, Appendable {// , Readable {
     ...
     * @since Android 1.0 */
    public static XCharBuffer allocate (int capacity) {
        if (capacity < 0) {
     ...
     * @return the created char buffer.
     * @since Android 1.0 */
    public static XCharBuffer wrap (char[] array) {
     ...
     * @since Android 1.0 */
    public static XCharBuffer wrap (char[] array, int start, int len) {
        int length = array.length;
        if ((start < 0) || (len < 0) || (long)start + (long)len > length) {
            throw new IndexOutOfBoundsException();
        }

        XCharBuffer buf = BufferFactory.newCharBuffer(array);
        buf.position = start;
        buf.limit = start + len;
     ...
     * @return the created char buffer.
     * @since Android 1.0 */
    public static XCharBuffer wrap (CharSequence chseq) {
     ...
     * @since Android 1.0 */
    public static XCharBuffer wrap (CharSequence chseq, int start, int end) {
        if (chseq == null) {
        ...
        XCharBuffer result = BufferFactory.newCharBuffer(chseq);
     ...
     * @since Android 1.0 */
    public abstract XCharBuffer asReadOnlyBuffer ();
     ...
     * @since Android 1.0 */
    public abstract XCharBuffer compact ();
     ...
     * @since Android 1.0 */
    public int compareTo (XCharBuffer otherBuffer) {
     ...
     * @since Android 1.0 */
    public abstract XCharBuffer duplicate ();
    ...
    public boolean equals (Object other) {
        if (!(other instanceof XCharBuffer)) {
            return false;
        }
        XCharBuffer otherBuffer = (XCharBuffer)other;
     ...
     * @since Android 1.0 */
    public XCharBuffer get (char[] dest) {
     ...
     * @since Android 1.0 */
    public XCharBuffer get (char[] dest, int off, int len) {
     ...
     * @exception ReadOnlyBufferException if no changes may be made to the contents of this buffer.
     * @since Android 1.0 */
    public abstract XCharBuffer put (char c);
     ...
     * @exception ReadOnlyBufferException if no changes may be made to the contents of this buffer.
     * @since Android 1.0 */
    public final XCharBuffer put (char[] src) {
     ...
     * @exception ReadOnlyBufferException if no changes may be made to the contents of this buffer.
     * @since Android 1.0 */
    public XCharBuffer put (XCharBuffer src) {
        if (src == this) {
            throw new IllegalArgumentException();
        }
     ...
     * @exception ReadOnlyBufferException if no changes may be made to the contents of this buffer.
     * @since Android 1.0 */
    public abstract XCharBuffer put (int index, char c);
     ...
     * @exception ReadOnlyBufferException if no changes may be made to the contents of this buffer.
     * @since Android 1.0 */
    public final XCharBuffer put (String str) {
     ...
     * @exception ReadOnlyBufferException if no changes may be made to the contents of this buffer.
     * @since Android 1.0 */
    public XCharBuffer put (String str, int start, int end) {
     ...
     * @since Android 1.0 */
    public abstract XCharBuffer slice ();
     ...
     * @exception ReadOnlyBufferException if no changes may be made to the contents of this buffer.
     * @since Android 1.0 */
    public XCharBuffer append (char c) {
        return put(c);
    }
     ...
     * @exception ReadOnlyBufferException if no changes may be made to the contents of this buffer.
     * @since Android 1.0 */
    public XCharBuffer append (CharSequence csq) {
        if (csq != null) {
     ...
     * @exception ReadOnlyBufferException if no changes may be made to the contents of this buffer.
     * @since Android 1.0 */
    public XCharBuffer append (CharSequence csq, int start, int end) {
        if (csq == null) {
            csq = "null"; //$NON-NLS-1$
        }
     ...
     * @since Android 1.0 */
    public int read (XCharBuffer target) throws IOException {
        if (target == this) {
            throw new IllegalArgumentException();
        }
        if (remaining() == 0) {
