 ...
 *
 * @since Android 1.0 */
public abstract class XLongBuffer extends XBuffer implements Comparable<XLongBuffer> {
     ...
     * @since Android 1.0 */
    public static XLongBuffer allocate (int capacity) {
        if (capacity < 0) {
     ...
     * @return the created long buffer.
     * @since Android 1.0 */
    public static XLongBuffer wrap (long[] array) {
     ...
     * @since Android 1.0 */
    public static XLongBuffer wrap (long[] array, int start, int len) {
        if (array == null) {
        ...
        XLongBuffer buf = BufferFactory.newLongBuffer(array);
        buf.position = start;
        buf.limit = start + len;
     ...
     * @since Android 1.0 */
    public abstract XLongBuffer asReadOnlyBuffer ();
     ...
     * @since Android 1.0 */
    public abstract XLongBuffer compact ();
     ...
     * @since Android 1.0 */
    public int compareTo (XLongBuffer otherBuffer) {
     ...
     * @since Android 1.0 */
    public abstract XLongBuffer duplicate ();
    ...
    public boolean equals (Object other) {
        if (!(other instanceof XLongBuffer)) {
            return false;
        }
        XLongBuffer otherBuffer = (XLongBuffer)other;
     ...
     * @since Android 1.0 */
    public XLongBuffer get (long[] dest) {
     ...
     * @since Android 1.0 */
    public XLongBuffer get (long[] dest, int off, int len) {
     ...
     * @exception ReadOnlyBufferException if no changes may be made to the contents of this buffer.
     * @since Android 1.0 */
    public abstract XLongBuffer put (long l);
     ...
     * @exception ReadOnlyBufferException if no changes may be made to the contents of this buffer.
     * @since Android 1.0 */
    public final XLongBuffer put (long[] src) {
     ...
     * @exception ReadOnlyBufferException if no changes may be made to the contents of this buffer.
     * @since Android 1.0 */
    public XLongBuffer put (XLongBuffer src) {
        if (src == this) {
            throw new IllegalArgumentException();
        }
     ...
     * @exception ReadOnlyBufferException if no changes may be made to the contents of this buffer.
     * @since Android 1.0 */
    public abstract XLongBuffer put (int index, long l);
     ...
     * @since Android 1.0 */
    public abstract XLongBuffer slice ();
