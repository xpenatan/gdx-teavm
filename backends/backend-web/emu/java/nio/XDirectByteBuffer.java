 ...
 * </p> */
abstract class XDirectByteBuffer extends XBaseByteBuffer
{

    Int8ArrayWrapper byteArray;

    XDirectByteBuffer(int capacity)
    {
        this(TypedArrays.getInstance().createArrayBuffer(capacity), capacity, 0);
    }

    XDirectByteBuffer(ArrayBufferWrapper buf)
    {
        this(buf, buf.getByteLength(), 0);
    }

    XDirectByteBuffer(ArrayBufferWrapper buffer, int capacity, int offset)
    {
        super(capacity);
        byteArray= TypedArrays.getInstance().createInt8Array(buffer, offset, capacity);
    }
