 ...
 *
 * @since Android 1.0 */
public abstract class XDoubleBuffer extends XBuffer implements Comparable<XDoubleBuffer> {
     ...
     * @since Android 1.0 */
    public static XDoubleBuffer allocate (int capacity) {
        if (capacity < 0) {
     ...
     * @return the created double buffer.
     * @since Android 1.0 */
    public static XDoubleBuffer wrap (double[] array) {
     ...
     * @since Android 1.0 */
    public static XDoubleBuffer wrap (double[] array, int start, int len) {
        int length = array.length;
        if (start < 0 || len < 0 || (long)start + (long)len > length) {
            throw new IndexOutOfBoundsException();
        }

        XDoubleBuffer buf = BufferFactory.newDoubleBuffer(array);
        buf.position = start;
        buf.limit = start + len;
     ...
     * @since Android 1.0 */
    public abstract XDoubleBuffer asReadOnlyBuffer ();
     ...
     * @since Android 1.0 */
    public abstract XDoubleBuffer compact ();
     ...
     * @since Android 1.0 */
    public int compareTo (XDoubleBuffer otherBuffer) {
     ...
     * @since Android 1.0 */
    public abstract XDoubleBuffer duplicate ();
    ...
    public boolean equals (Object other) {
        if (!(other instanceof XDoubleBuffer)) {
            return false;
        }
        XDoubleBuffer otherBuffer = (XDoubleBuffer)other;
     ...
     * @since Android 1.0 */
    public XDoubleBuffer get (double[] dest) {
     ...
     * @since Android 1.0 */
    public XDoubleBuffer get (double[] dest, int off, int len) {
...
// }
     ...
     * @exception ReadOnlyBufferException if no changes may be made to the contents of this buffer.
     * @since Android 1.0 */
    public abstract XDoubleBuffer put (double d);
     ...
     * @exception ReadOnlyBufferException if no changes may be made to the contents of this buffer.
     * @since Android 1.0 */
    public final XDoubleBuffer put (double[] src) {
     ...
     * @exception ReadOnlyBufferException if no changes may be made to the contents of this buffer.
     * @since Android 1.0 */
    public XDoubleBuffer put (XDoubleBuffer src) {
        if (src == this) {
            throw new IllegalArgumentException();
        }
     ...
     * @exception ReadOnlyBufferException if no changes may be made to the contents of this buffer.
     * @since Android 1.0 */
    public abstract XDoubleBuffer put (int index, double d);
     ...
     * @since Android 1.0 */
    public abstract XDoubleBuffer slice ();
