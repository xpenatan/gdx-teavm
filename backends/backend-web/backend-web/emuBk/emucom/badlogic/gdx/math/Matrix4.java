...
package emucom.badlogic.gdx.math;
...
public class Matrix4 implements Serializable {
    ...
    public float getScaleX() {
        return (emucom.badlogic.gdx.math.MathUtils.isZero(val[Matrix4.M01]) && emucom.badlogic.gdx.math.MathUtils.isZero(val[Matrix4.M02])) ? Math.abs(val[Matrix4.M00])
    ...
    public float getScaleY() {
        return (emucom.badlogic.gdx.math.MathUtils.isZero(val[Matrix4.M10]) && emucom.badlogic.gdx.math.MathUtils.isZero(val[Matrix4.M12])) ? Math.abs(val[Matrix4.M11])
    ...
    public float getScaleZ() {
        return (emucom.badlogic.gdx.math.MathUtils.isZero(val[Matrix4.M20]) && emucom.badlogic.gdx.math.MathUtils.isZero(val[Matrix4.M21])) ? Math.abs(val[Matrix4.M22])
    ...
    public boolean hasRotationOrScaling() {
        return !(emucom.badlogic.gdx.math.MathUtils.isEqual(val[M00], 1) && emucom.badlogic.gdx.math.MathUtils.isEqual(val[M11], 1) && emucom.badlogic.gdx.math.MathUtils.isEqual(val[M22], 1)
                && emucom.badlogic.gdx.math.MathUtils.isZero(val[M01]) && emucom.badlogic.gdx.math.MathUtils.isZero(val[M02]) && emucom.badlogic.gdx.math.MathUtils.isZero(val[M10]) && emucom.badlogic.gdx.math.MathUtils.isZero(val[M12])
                && emucom.badlogic.gdx.math.MathUtils.isZero(val[M20]) && MathUtils.isZero(val[M21]));
    }
