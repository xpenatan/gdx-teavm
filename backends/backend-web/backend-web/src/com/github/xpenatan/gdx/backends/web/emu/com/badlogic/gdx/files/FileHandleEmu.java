package com.github.xpenatan.gdx.backends.web.emu.com.badlogic.gdx.files;
...
@Emulate(FileHandle.class)
public class FileHandleEmu {
    protected File file;
    protected FileType type;

    protected FileHandleEmu() {
    }

    public FileHandleEmu(String fileName) {
    }

    public FileHandleEmu(File file) {
    }

    protected FileHandleEmu(String fileName, FileType type) {
    }

    protected FileHandleEmu(File file, FileType type) {
    }
