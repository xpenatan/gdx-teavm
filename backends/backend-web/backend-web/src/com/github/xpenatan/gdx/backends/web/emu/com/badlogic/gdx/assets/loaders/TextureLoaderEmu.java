...
package com.github.xpenatan.gdx.backends.web.emu.com.badlogic.gdx.assets.loaders;
...
public class TextureLoaderEmu extends AsynchronousAssetLoader<Texture, TextureLoaderEmu.TextureParameter> {
    TextureData data;
    Texture texture;
