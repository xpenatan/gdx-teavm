...
@Emulate(Quaternion.class)
public class QuaternionEmu implements Serializable {
	private static final long serialVersionUID = -7661875440774897168L;
	private static QuaternionEmu tmp1 = new QuaternionEmu(0, 0, 0, 0);
	private static QuaternionEmu tmp2 = new QuaternionEmu(0, 0, 0, 0);
	...
	public QuaternionEmu(float x, float y, float z, float w) {
		this.set(x, y, z, w);
	}

	public QuaternionEmu() {
		idt();
	}
	...
	public QuaternionEmu(QuaternionEmu quaternion) {
		this.set(quaternion);
	}
	...
	public QuaternionEmu(Vector3 axis, float angle) {
		this.set(axis, angle);
	}
	...
	public QuaternionEmu set (float x, float y, float z, float w) {
		this.x = x;
		this.y = y;
		this.z = z;
		this.w = w;
	 ...
	 * @return This quaternion for chaining. */
	public QuaternionEmu set (QuaternionEmu quaternion) {
	 ...
	 * @param angle The angle in degrees
	 * @return This quaternion for chaining. */
	public QuaternionEmu set (Vector3 axis, float angle) {
		return setFromAxis(axis.x, axis.y, axis.z, angle);
	}

	/** @return a copy of this quaternion */
	public QuaternionEmu cpy () {
		return new QuaternionEmu(this);
	}
	...
	public QuaternionEmu setEulerAngles (float yaw, float pitch, float roll) {
	 ...
	 * @return this quaternion */
	public QuaternionEmu setEulerAnglesRad (float yaw, float pitch, float roll) {
	 ...
	 * 
	 * @return This quaternion for chaining */
	public QuaternionEmu conjugate () {
		x = -x;
		y = -y;
		z = -z;
		return this;
	 ...
	 * @return This quaternion for chaining */
	public QuaternionEmu mul (final QuaternionEmu other) {
	 ...
	 * @return This quaternion for chaining */
	public QuaternionEmu mul (final float x, final float y, final float z, final float w) {
	 ...
	 * @param other Quaternion to multiply with
	 * @return This quaternion for chaining */
	public QuaternionEmu mulLeft (QuaternionEmu other) {
	 ...
	 * @param w the w component of the other quaternion to multiply with
	 * @return This quaternion for chaining */
	public QuaternionEmu mulLeft (final float x, final float y, final float z, final float w) {
	...
	public QuaternionEmu add (QuaternionEmu quaternion) {
		this.x += quaternion.x;
		this.y += quaternion.y;
		this.z += quaternion.z;
		this.w += quaternion.w;
	...
	/** Add the x,y,z,w components of the passed in quaternion to the ones of this quaternion */
	public QuaternionEmu add (float qx, float qy, float qz, float qw) {
		this.x += qx;
		this.y += qy;
		this.z += qz;
		this.w += qw;
...
// method
	...
	public void toMatrix (final float[] matrix) {
		...
		matrix[Matrix4Emu.M00] = 1 - 2 * (yy + zz);
		matrix[Matrix4Emu.M01] = 2 * (xy - zw);
		matrix[Matrix4Emu.M02] = 2 * (xz + yw);
		matrix[Matrix4Emu.M03] = 0;
		matrix[Matrix4Emu.M10] = 2 * (xy + zw);
		matrix[Matrix4Emu.M11] = 1 - 2 * (xx + zz);
		matrix[Matrix4Emu.M12] = 2 * (yz - xw);
		matrix[Matrix4Emu.M13] = 0;
		matrix[Matrix4Emu.M20] = 2 * (xz - yw);
		matrix[Matrix4Emu.M21] = 2 * (yz + xw);
		matrix[Matrix4Emu.M22] = 1 - 2 * (xx + yy);
		matrix[Matrix4Emu.M23] = 0;
		matrix[Matrix4Emu.M30] = 0;
		matrix[Matrix4Emu.M31] = 0;
		matrix[Matrix4Emu.M32] = 0;
		matrix[Matrix4Emu.M33] = 1;
	}

	/** Sets the quaternion to an identity Quaternion
	 * @return this quaternion for chaining */
	public QuaternionEmu idt () {
	 ...
	 * @return This quaternion for chaining. */
	public QuaternionEmu setFromAxis (final Vector3 axis, final float degrees) {
	 ...
	 * @return This quaternion for chaining. */
	public QuaternionEmu setFromAxisRad (final Vector3 axis, final float radians) {
	 ...
	 * @param degrees The angle in degrees
	 * @return This quaternion for chaining. */
	public QuaternionEmu setFromAxis (final float x, final float y, final float z, final float degrees) {
	 ...
	 * @param radians The angle in radians
	 * @return This quaternion for chaining. */
	public QuaternionEmu setFromAxisRad (final float x, final float y, final float z, final float radians) {
	...
	public QuaternionEmu setFromMatrix (boolean normalizeAxes, Matrix4Emu matrix) {
		return setFromAxes(normalizeAxes, matrix.val[Matrix4Emu.M00], matrix.val[Matrix4Emu.M01], matrix.val[Matrix4Emu.M02],
			matrix.val[Matrix4Emu.M10], matrix.val[Matrix4Emu.M11], matrix.val[Matrix4Emu.M12], matrix.val[Matrix4Emu.M20],
			matrix.val[Matrix4Emu.M21], matrix.val[Matrix4Emu.M22]);
	}

	/** Sets the Quaternion from the given rotation matrix, which must not contain scaling. */
	public QuaternionEmu setFromMatrix (Matrix4Emu matrix) {
		return setFromMatrix(false, matrix);
	}

	/** Sets the Quaternion from the given matrix, optionally removing any scaling. */
	public QuaternionEmu setFromMatrix (boolean normalizeAxes, Matrix3 matrix) {
	...
	/** Sets the Quaternion from the given rotation matrix, which must not contain scaling. */
	public QuaternionEmu setFromMatrix (Matrix3 matrix) {
		return setFromMatrix(false, matrix);
	}
	...
	public QuaternionEmu setFromAxes (float xx, float xy, float xz, float yx, float yy, float yz, float zx, float zy, float zz) {
	 ...
	 * @param zy z-axis y-coordinate
	 * @param zz z-axis z-coordinate */
	public QuaternionEmu setFromAxes (boolean normalizeAxes, float xx, float xy, float xz, float yx, float yy, float yz, float zx,
                                      float zy, float zz) {
		if (normalizeAxes) {
	 ...
	 * @return This quaternion for chaining */
	public QuaternionEmu setFromCross (final Vector3 v1, final Vector3 v2) {
	 ...
	 * @return This quaternion for chaining */
	public QuaternionEmu setFromCross (final float x1, final float y1, final float z1, final float x2, final float y2, final float z2) {
	 ...
	 * @return this quaternion for chaining */
	public QuaternionEmu slerp (QuaternionEmu end, float alpha) {
	 ...
	 * @return This quaternion for chaining */
	public QuaternionEmu slerp (QuaternionEmu[] q) {
	 ...
	 * @return This quaternion for chaining */
	public QuaternionEmu slerp (QuaternionEmu[] q, float[] w) {
	 ...
	 * @return This quaternion for chaining */
	public QuaternionEmu exp (float alpha) {
...
// value
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof QuaternionEmu)) {
			return false;
		}
		QuaternionEmu other = (QuaternionEmu)obj;
	...
	public float dot (final QuaternionEmu other) {
	 ...
	 * @return this quaternion for chaining. */
	public QuaternionEmu mul (float scalar) {
		this.x *= scalar;
		this.y *= scalar;
		this.z *= scalar;
		this.w *= scalar;
	...
	public void getSwingTwist (final float axisX, final float axisY, final float axisZ, final QuaternionEmu swing,
		final QuaternionEmu twist) {
	 ...
	 * @param twist will receive the twist rotation: the rotation around the specified axis
	 * @see <a href="http://www.euclideanspace.com/maths/geometry/rotations/for/decomposition">calculation</a> */
	public void getSwingTwist (final Vector3 axis, final QuaternionEmu swing, final QuaternionEmu twist) {
	...
	public float getAngleAroundRad (final float axisX, final float axisY, final float axisZ) {
		final float d = Vector3.dot(this.x, this.y, this.z, axisX, axisY, axisZ);
		final float l2 = QuaternionEmu.len2(axisX * d, axisY * d, axisZ * d, this.w);
