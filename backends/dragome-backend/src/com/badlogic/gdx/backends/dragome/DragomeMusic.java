...
import com.badlogic.gdx.backends.dragome.soundmanager2.SMSound.SMSoundCallback;
import com.badlogic.gdx.backends.dragome.soundmanager2.SMSoundOptions;
import com.badlogic.gdx.backends.dragome.soundmanager2.SoundManager;
import com.badlogic.gdx.files.FileHandle;

/** Ported from GWT backend
 * @author xpenatan */
public class DragomeMusic implements Music, SMSoundCallback {
	...
	public DragomeMusic (FileHandle file) {
		String url = ((DragomeApplication)Gdx.app).getAssetUrl() + file.path();
