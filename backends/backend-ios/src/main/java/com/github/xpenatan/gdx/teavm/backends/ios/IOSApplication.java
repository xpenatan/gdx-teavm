...
public class IOSApplication implements Application {
    ...
    private final IOSInput input;
    private final IOSAudio audio;
    private final IOSFiles files;
    ...
    public IOSApplication(ApplicationListener listener) {
        this(listener, new IOSApplicationConfiguration());
    }

    public IOSApplication(ApplicationListener listener, IOSApplicationConfiguration config) {
        IOSApplicationConfiguration finalConfig = config == null ? new IOSApplicationConfiguration() : config;
        this.listener = listener;
        this.graphics = new IOSGraphics(finalConfig);
    ...
    @Export(name = "gdx_teavm_ios_pause")
    ...
    @Export(name = "gdx_teavm_ios_resume")
    ...
    @Export(name = "gdx_teavm_ios_dispose")
    ...
    @Export(name = "gdx_teavm_ios_touch")
