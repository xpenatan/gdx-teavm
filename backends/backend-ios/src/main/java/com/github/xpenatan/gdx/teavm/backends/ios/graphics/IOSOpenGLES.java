...
public class IOSOpenGLES {
    ...
    @Import(name = "gdx_teavm_ios_glShaderSource")
    public static native void gdxTeavmIosGlShaderSource(int shader, int length, Address sourceData);
