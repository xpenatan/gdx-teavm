...
public interface Uint8ClampedArray extends Uint8Array {
	...
	public static Uint8ClampedArray createClamped (ArrayBuffer buffer) {
		...
		Uint8ClampedArray node = JsDelegateFactory.createFrom(instance, Uint8ClampedArray.class);
		return node;
	}
	...
	public static Uint8ClampedArray createClamped (ArrayBuffer buffer, int byteOffset) {
		...
		Object instance = ScriptHelper.eval("new Uint8ClampedArray(buffer.node, byteOffset);", null);
		Uint8ClampedArray node = JsDelegateFactory.createFrom(instance, Uint8ClampedArray.class);
		return node;
	};
	...
	public static Uint8ClampedArray createClamped (ArrayBuffer buffer, int byteOffset, int length) {
		...
		Object instance = ScriptHelper.eval("new Uint8ClampedArray(buffer.node, byteOffset, length);", null);
		Uint8ClampedArray node = JsDelegateFactory.createFrom(instance, Uint8ClampedArray.class);
		return node;
	};
