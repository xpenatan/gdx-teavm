...
public class TypedArrays {
	...
	public abstract static class Impl {
		 ...
		 * <p>
		 * The default implementation always returns true, and this is intended to be a static check based on deffered-bound
		 * parameters.
		 * 
		...
		/** Check if the current environment actually does support typed arrays (including emulation). There is no partial support,
		 * so if true is returned, there must be acceptable implementations for all of the {@code createXXX} methods.
		 * 
	...
	/** Create a new {@link DataView} instance on an {@link ArrayBuffer}, starting at an offset of {@code byteOffset}.
	 * 
	 * @param buffer {@link ArrayBuffer}
	...
	/** Create a new {@link DataView} instance on an {@link ArrayBuffer}, starting at an offset of {@code byteOffset} and
	 * continuing for {@code length} bytes.
	 * 
	 * @param buffer {@link ArrayBuffer}
	 * @param byteOffset offset into buffer
	...
	/** Create a {@link Float32Array} instance on {@code buffer}, starting at starting at the beginning of the buffer and
	 * continuing to the end (which must be an integral number of elements).
	 * 
	...
	/** Create a {@link Float32Array} instance on {@code buffer}, starting at {@code byteOffset} into the buffer, continuing to the
	 * end of the buffer (which must be an integral number of elements).
	 * 
	 * @param buffer underlying {@link ArrayBuffer}
	...
	/** Create a {@link Float32Array} instance on {@code buffer}, starting at {@code byteOffset} into the buffer, continuing for
	...
	/** Create a {@link Float32Array} instance of {@code length} elements, backed by a new {@link ArrayBuffer}.
	 * 
	...
	/** Create a {@link Float64Array} instance on {@code buffer}, starting at starting at the beginning of the buffer and
	 * continuing to the end (which must be an integral number of elements).
	 * <p>
	...
	/** Create a {@link Float64Array} instance on {@code buffer}, starting at {@code byteOffset} into the buffer, continuing to the
	 * end of the buffer (which must be an integral number of elements).
	 * <p>
	 * <b>Note that Safari does not currently support Float64 Arrays!</b>
	 * 
	...
	/** Create a {@link Float64Array} instance on {@code buffer}, starting at {@code byteOffset} into the buffer, continuing for
	 * {@code length} elements.
	 * <p>
	 * <b>Note that Safari does not currently support Float64 Arrays!</b>
	 * 
	...
	/** Create a {@link Float64Array} instance of {@code length} elements, backed by a new {@link ArrayBuffer}.
	 * <p>
	 * <b>Note that Safari does not currently support Float64 Arrays!</b>
	 * 
	 * @param length size of array
	...
	/** Create a {@link Int16Array} instance on {@code buffer}, starting at starting at the beginning of the buffer and continuing
	 * to the end (which must be an integral number of elements).
	 * 
	 * @param buffer underlying {@link ArrayBuffer}
	...
	/** Create a {@link Int16Array} instance on {@code buffer}, starting at {@code byteOffset} into the buffer, continuing to the
	 * end of the buffer (which must be an integral number of elements).
	 * 
	 * @param buffer underlying {@link ArrayBuffer}
	 * @param byteOffset byte offset from the start of {@code buffer}
	...
	/** Create a {@link Int16Array} instance on {@code buffer}, starting at {@code byteOffset} into the buffer, continuing for
	 * {@code length} elements.
	 * 
	 * @param buffer underlying {@link ArrayBuffer}
	 * @param byteOffset byte offset from the start of {@code buffer}
	...
	/** Create a {@link Int16Array} instance of {@code length} elements, backed by a new {@link ArrayBuffer}.
	 * 
	 * @param length size of array
	...
	/** Create a {@link Int32Array} instance on {@code buffer}, starting at starting at the beginning of the buffer and continuing
	 * to the end (which must be an integral number of elements).
	 * 
	 * @param buffer underlying {@link ArrayBuffer}
	...
	/** Create a {@link Int32Array} instance on {@code buffer}, starting at {@code byteOffset} into the buffer, continuing to the
	 * end of the buffer (which must be an integral number of elements).
	 * 
	 * @param buffer underlying {@link ArrayBuffer}
	 * @param byteOffset byte offset from the start of {@code buffer}
	...
	/** Create a {@link Int32Array} instance on {@code buffer}, starting at {@code byteOffset} into the buffer, continuing for
	 * {@code length} elements.
	 * 
	 * @param buffer underlying {@link ArrayBuffer}
	 * @param byteOffset byte offset from the start of {@code buffer}
	...
	/** Create a {@link Int32Array} instance of {@code length} elements, backed by a new {@link ArrayBuffer}.
	 * 
	 * @param length size of array
	...
	/** Create a {@link Int8Array} instance on {@code buffer}, starting at starting at the beginning of the buffer and continuing
	 * to the end.
	 * 
	 * @param buffer underlying {@link ArrayBuffer}
	...
	/** Create a {@link Int8Array} instance on {@code buffer}, starting at {@code byteOffset} into the buffer, continuing to the
	 * end of the buffer (which must be an integral number of elements).
	 * 
	 * @param buffer underlying {@link ArrayBuffer}
	 * @param byteOffset byte offset from the start of {@code buffer}
	...
	/** Create a {@link Int8Array} instance on {@code buffer}, starting at {@code byteOffset} into the buffer, continuing for
	 * {@code length} elements.
	 * 
	 * @param buffer underlying {@link ArrayBuffer}
	 * @param byteOffset byte offset from the start of {@code buffer}
	...
	/** Create a {@link Int8Array} instance of {@code length} elements, backed by a new {@link ArrayBuffer}.
	 * 
	 * @param length size of array
	...
	/** Create a {@link Uint16Array} instance on {@code buffer}, starting at starting at the beginning of the buffer and continuing
	 * to the end (which must be an integral number of elements).
	 * 
	 * @param buffer underlying {@link ArrayBuffer}
	...
	/** Create a {@link Uint16Array} instance on {@code buffer}, starting at {@code byteOffset} into the buffer, continuing to the
	 * end of the buffer (which must be an integral number of elements).
	 * 
	 * @param buffer underlying {@link ArrayBuffer}
	 * @param byteOffset byte offset from the start of {@code buffer}
	...
	/** Create a {@link Uint16Array} instance on {@code buffer}, starting at {@code byteOffset} into the buffer, continuing for
	 * {@code length} elements.
	 * 
	 * @param buffer underlying {@link ArrayBuffer}
	 * @param byteOffset byte offset from the start of {@code buffer}
	...
	/** Create a {@link Uint16Array} instance of {@code length} elements, backed by a new {@link ArrayBuffer}.
	 * 
	 * @param length size of array
	...
	/** Create a {@link Uint32Array} instance on {@code buffer}, starting at starting at the beginning of the buffer and continuing
	 * to the end (which must be an integral number of elements).
	 * 
	 * @param buffer underlying {@link ArrayBuffer}
	...
	/** Create a {@link Uint32Array} instance on {@code buffer}, starting at {@code byteOffset} into the buffer, continuing to the
	 * end of the buffer (which must be an integral number of elements).
	 * 
	 * @param buffer underlying {@link ArrayBuffer}
	 * @param byteOffset byte offset from the start of {@code buffer}
	...
	/** Create a {@link Uint32Array} instance on {@code buffer}, starting at {@code byteOffset} into the buffer, continuing for
	 * {@code length} elements.
	 * 
	 * @param buffer underlying {@link ArrayBuffer}
	 * @param byteOffset byte offset from the start of {@code buffer}
	...
	/** Create a {@link Uint32Array} instance of {@code length} elements, backed by a new {@link ArrayBuffer}.
	 * 
	 * @param length size of array
	...
	/** Create a {@link Uint8Array} instance on {@code buffer}, starting at starting at the beginning of the buffer and continuing
	 * to the end (which must be an integral number of elements).
	 * 
	 * @param buffer underlying {@link ArrayBuffer}
	...
	/** Create a {@link Uint8Array} instance on {@code buffer}, starting at {@code byteOffset} into the buffer, continuing to the
	 * end of the buffer.
	 * 
	 * @param buffer underlying {@link ArrayBuffer}
	 * @param byteOffset byte offset from the start of {@code buffer}
	...
	/** Create a {@link Uint8Array} instance on {@code buffer}, starting at {@code byteOffset} into the buffer, continuing for
	 * {@code length} elements.
	 * 
	 * @param buffer underlying {@link ArrayBuffer}
	 * @param byteOffset byte offset from the start of {@code buffer}
	...
	/** Create a {@link Uint8Array} instance of {@code length} elements, backed by a new {@link ArrayBuffer}.
	 * 
	 * @param length size of array
	...
	/** Create a {@link Uint8ClampedArray} instance on {@code buffer}, starting at starting at the beginning of the buffer and
	...
	/** Create a {@link Uint8ClampedArray} instance of {@code length} elements, backed by a new {@link ArrayBuffer}.
	 * 
	 * @param length size of array
	...
	/** Check if the current environment supports typed arrays. Behavior of the various {@code createXXX} methods is undefined if
	 * this method returns {@code false}, but will typically throw some exception.
	 * 
