...
public class DragomeFileHandle extends FileHandle {
	...
	public DragomeFileHandle (Preloader preloader, String fileName, FileType type) {
	...
	public DragomeFileHandle (String path) {
		this.type = FileType.Internal;
		this.preloader = ((DragomeApplication)Gdx.app).getPreloader();
	...
	public FileHandle child (String name) {
		return new DragomeFileHandle(preloader, (file.isEmpty() ? "" : (file + (file.endsWith("/") ? "" : "/"))) + name,
			FileType.Internal);
	}
	...
	public FileHandle parent () {
		...
		return new DragomeFileHandle(preloader, dir, type);
	}
