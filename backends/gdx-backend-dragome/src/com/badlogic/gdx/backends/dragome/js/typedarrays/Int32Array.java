...
public interface Int32Array extends ArrayBufferView {
	...
	public static Int32Array create (ArrayBuffer buffer) {
		Int32Array node = ScriptHelper.evalCasting("new Int32Array(buffer.node)", Int32Array.class, null);
		return node;
	}
	
	@DelegateCode(ignore = true)
	public static Int32Array create (ArrayBuffer buffer, int byteOffset) {
		Int32Array node = ScriptHelper.evalCasting("new Int32Array(buffer.node, byteOffset)", Int32Array.class, null);
		return node;
	};

	@DelegateCode(ignore = true)
	public static Int32Array create (ArrayBuffer buffer, int byteOffset, int length) {
		Int32Array node = ScriptHelper.evalCasting("new Int32Array(buffer.node, byteOffset, length)", Int32Array.class, null);
		return node;
	};

	@DelegateCode(ignore = true)
	public static Int32Array create (int length) {
		Int32Array node = ScriptHelper.evalCasting("new Int32Array(length)", Int32Array.class, null);
		return node;
	};
