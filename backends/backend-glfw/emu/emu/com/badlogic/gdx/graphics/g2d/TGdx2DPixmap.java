...
public class TGdx2DPixmap implements Disposable, TPixmapNativeInterface {
     ...
     */
    public TGdx2DPixmap(int width, int height, int format) throws GdxRuntimeException {
        nativePixmap = new TGdx2DPixmapNative(width, height, format);
    }
    ...
    public static TGdx2DPixmap newPixmap(InputStream in, int requestedFormat) {
        throw new GdxRuntimeException("newPixmap not supported 1");
//        try {
//            return new Gdx2DPixmapEmuEmu(in, requestedFormat);
//        } catch(IOException e) {
//            return null;
//        }
    }

    public static TGdx2DPixmap newPixmap(int width, int height, int format) {
        try {
            return new TGdx2DPixmap(width, height, format);
