...
import emu.com.badlogic.gdx.utils.async.TAsyncExecutor;
import emu.com.badlogic.gdx.utils.async.TAsyncResult;
import emu.com.badlogic.gdx.utils.async.TAsyncTask;

public class TAssetLoadingTask implements TAsyncTask<Void> {
    AssetManager manager;
    final AssetDescriptor assetDesc;
    final com.badlogic.gdx.assets.loaders.AssetLoader loader;
    final TAsyncExecutor executor;
    final long startTime;

    volatile boolean asyncDone;
    volatile boolean dependenciesLoaded;
    volatile Array<AssetDescriptor> dependencies;
    volatile TAsyncResult<Void> depsFuture;
    volatile TAsyncResult<Void> loadFuture;
    ...
    public TAssetLoadingTask(AssetManager manager, AssetDescriptor assetDesc, com.badlogic.gdx.assets.loaders.AssetLoader loader, TAsyncExecutor threadPool) {
