...
public class GLFWWindowConfiguration {
    ...
    /**
     * Sets the {@link GLFWWindowListener} which will be informed about iconficiation, focus loss and window close events.
     */
    public void setWindowListener(GLFWWindowListener windowListener) {
        this.windowListener = windowListener;
    }

    /**
     * Sets the app to use fullscreen mode. Use the static methods like {@link GLFWApplicationConfiguration#getDisplayMode()} on
