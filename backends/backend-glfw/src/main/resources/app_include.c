...
void teavm_spritebatch_draw_texture_transform(void* batch_obj, void* texture, float x, float y, float origin_x, float origin_y, float width, float height, float scale_x, float scale_y, float rotation, int32_t src_x, int32_t src_y, int32_t src_width, int32_t src_height, int32_t flip_x, int32_t flip_y);
void teavm_spritebatch_draw_texture_rect(void* batch_obj, void* texture, float x, float y, float width, float height);
