...
public enum TimeUnit {
  ...
  MICROSECONDS {
    public long toNanos(long d)   { return TimeUnit.x(d, C1_C0, MAX_C1_C0); }
  ...
  MILLISECONDS {
    public long toNanos(long d)   { return TimeUnit.x(d, C2_C0, MAX_C2_C0); }
    public long toMicros(long d)  { return TimeUnit.x(d, C2_C1, MAX_C2_C1); }
  ...
  SECONDS {
    public long toNanos(long d)   { return TimeUnit.x(d, C3_C0, MAX_C3_C0); }
    public long toMicros(long d)  { return TimeUnit.x(d, C3_C1, MAX_C3_C1); }
    public long toMillis(long d)  { return TimeUnit.x(d, C3_C2, MAX_C3_C2); }
  ...
  MINUTES {
    public long toNanos(long d)   { return TimeUnit.x(d, C4_C0, MAX_C4_C0); }
    public long toMicros(long d)  { return TimeUnit.x(d, C4_C1, MAX_C4_C1); }
    public long toMillis(long d)  { return TimeUnit.x(d, C4_C2, MAX_C4_C2); }
    public long toSeconds(long d) { return TimeUnit.x(d, C4_C3, MAX_C4_C3); }
  ...
  HOURS {
    public long toNanos(long d)   { return TimeUnit.x(d, C5_C0, MAX_C5_C0); }
    public long toMicros(long d)  { return TimeUnit.x(d, C5_C1, MAX_C5_C1); }
    public long toMillis(long d)  { return TimeUnit.x(d, C5_C2, MAX_C5_C2); }
    public long toSeconds(long d) { return TimeUnit.x(d, C5_C3, MAX_C5_C3); }
    public long toMinutes(long d) { return TimeUnit.x(d, C5_C4, MAX_C5_C4); }
  ...
  DAYS {
    public long toNanos(long d)   { return TimeUnit.x(d, C6_C0, MAX_C6_C0); }
    public long toMicros(long d)  { return TimeUnit.x(d, C6_C1, MAX_C6_C1); }
    public long toMillis(long d)  { return TimeUnit.x(d, C6_C2, MAX_C6_C2); }
    public long toSeconds(long d) { return TimeUnit.x(d, C6_C3, MAX_C6_C3); }
    public long toMinutes(long d) { return TimeUnit.x(d, C6_C4, MAX_C6_C4); }
    public long toHours(long d)   { return TimeUnit.x(d, C6_C5, MAX_C6_C5); }
