...
class TFloatBufferOverByteBufferLittleEndian extends TFloatBufferOverByteBuffer {
    ...
    float getElement(int index) {
        int value = ((byteByffer.array.get(start + index * 4) & 0xFF) << 24)
                | ((byteByffer.array.get(start + index * 4 + 1) & 0xFF) << 16)
                | ((byteByffer.array.get(start + index * 4 + 2) & 0xFF) << 8)
                | (byteByffer.array.get(start + index * 4 + 3) & 0xFF);
    ...
    void putElement(int index, float f) {
        ...
        byteByffer.array.set(start + index * 4, (byte) (value >> 24));
        byteByffer.array.set(start + index * 4 + 1, (byte) (value >> 16));
        byteByffer.array.set(start + index * 4 + 2, (byte) (value >> 8));
        byteByffer.array.set(start + index * 4 + 3, (byte) value);
    }
