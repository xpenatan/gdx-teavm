 ...
 * @author mrdlink
 */
@Emulate(InstanceBufferObject.class)
public class InstanceBufferObjectEmu implements InstanceData {
    ...
    public InstanceBufferObjectEmu(boolean isStatic, int numVertices, VertexAttribute... attributes) {
        this(isStatic, numVertices, new VertexAttributes(attributes));
    }

    public InstanceBufferObjectEmu(boolean isStatic, int numVertices, VertexAttributes instanceAttributes) {
        if(Gdx.gl30 == null)
