...
public class FreeTypePackTest implements ApplicationListener {
	...
	class FontMap<T> extends HashMap<FontStyle, HashMap<FontSize, T>> {

		public FontMap () {

			// create the enum map for each FontSize
			for (FontStyle style : FontStyle.values()) {
				put(style, new HashMap<FontSize, T>());
			}
		}
	}
	@Override
