...
public class SpriteBatchSimpleDirectBenchmark implements BenchmarkCase {
    ...
    public String getName() {
        return "spritebatch_simple_direct";
    }
    ...
    public void render() {
        ...
        for(int i = 0; i < spriteX.length; i++) {
            spriteBatch.draw(texture, spriteX[i], spriteY[i], SPRITE_WIDTH * 0.5f, SPRITE_HEIGHT * 0.5f,
                    SPRITE_WIDTH, SPRITE_HEIGHT, drawScale, drawScale, sharedRotation,
