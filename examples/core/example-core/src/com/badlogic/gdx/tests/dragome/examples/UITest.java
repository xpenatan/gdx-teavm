...
//		FileHandle internal = Gdx.files.internal("data/jsonTest.json");

		new JsonModel();

		System.out.println("pass000");
		Field[] declaredFields = JsonModel.class.getDeclaredFields();
		...
		System.out.println("pass111");


//		JsonModel fromJson = json.fromJson(JsonModel.class, internal);
