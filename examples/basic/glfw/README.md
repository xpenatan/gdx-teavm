...
**Release build**
```
gradlew :examples:basic:glfw:basic_build_teavm_glfw_release
```
...
```
gradlew :examples:basic:glfw:basic_build_teavm_glfw
```
...
```
gradlew :examples:basic:glfw:basic_run_teavm_glfw_debug
gradlew :examples:basic:glfw:basic_run_teavm_glfw_release
gradlew :examples:basic:glfw:basic_run_teavm_glfw_release_console
```
