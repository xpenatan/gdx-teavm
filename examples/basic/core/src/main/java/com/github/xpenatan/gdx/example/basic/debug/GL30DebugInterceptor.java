...
public class GL30DebugInterceptor extends GLDebugInterceptor implements GL30 {

    protected final GL30 gl30;

    protected GL30DebugInterceptor(GLDebugProfiler glProfiler, GL30 gl30) {
        super(glProfiler);
        this.gl30 = gl30;
    }
    ...
    public void glActiveTexture(int texture) {
        calls++;
        incrementMethod("glActiveTexture");
        incrementMethod("glActiveTexture");
    ...
    public void glClearStencil(int s) {
        calls++;
        incrementMethod("glClearStencil");
        incrementMethod("glClearStencil");
    ...
    public void glCompressedTexImage2D(int target, int level, int internalformat, int width, int height, int border,
        ...
        calls++;
        incrementMethod("glCompressedTexImage2D");
        incrementMethod("glCompressedTexImage2D");
    ...
    public void glCompressedTexSubImage2D(int target, int level, int xoffset, int yoffset, int width, int height, int format,
                                          int imageSize, Buffer data) {
        calls++;
        incrementMethod("glCompressedTexSubImage2D");
        incrementMethod("glCompressedTexSubImage2D");
    ...
    public void glCopyTexImage2D(int target, int level, int internalformat, int x, int y, int width, int height, int border) {
        calls++;
        incrementMethod("glCopyTexImage2D");
        incrementMethod("glCopyTexImage2D");
    ...
    public void glCopyTexSubImage2D(int target, int level, int xoffset, int yoffset, int x, int y, int width, int height) {
        calls++;
        incrementMethod("glCopyTexSubImage2D");
        incrementMethod("glCopyTexSubImage2D");
    ...
    public void glDeleteTextures(int n, IntBuffer textures) {
        calls++;
        incrementMethod("glDeleteTextures");
        incrementMethod("glDeleteTextures");
    ...
    public void glDeleteTexture(int texture) {
        calls++;
        incrementMethod("glDeleteTexture");
        incrementMethod("glDeleteTexture");
    ...
    public void glDrawElements(int mode, int count, int type, Buffer indices) {
        vertexCount.put(count);
        drawCalls++;
        incrementMethod("glDrawElements");
        incrementMethod("glDrawElements");
        calls++;
        incrementMethod("glDrawElements");
        incrementMethod("glDrawElements");
    ...
    public void glPolygonOffset(float factor, float units) {
        calls++;
        incrementMethod("glPolygonOffset");
        incrementMethod("glPolygonOffset");
    ...
    public void glTexParameterf(int target, int pname, float param) {
        calls++;
        incrementMethod("glTexParameterf");
        incrementMethod("glTexParameterf");
    ...
    public void glTexSubImage2D(int target, int level, int xoffset, int yoffset, int width, int height, int format, int type,
                                Buffer pixels) {
        calls++;
        incrementMethod("glTexSubImage2D");
        incrementMethod("glTexSubImage2D");
    ...
    public void glAttachShader(int program, int shader) {
        calls++;
        incrementMethod("glAttachShader");
        incrementMethod("glAttachShader");
    ...
    public void glBindAttribLocation(int program, int index, String name) {
        calls++;
        incrementMethod("glBindAttribLocation");
        incrementMethod("glBindAttribLocation");
    ...
    public void glBindFramebuffer(int target, int framebuffer) {
        calls++;
        incrementMethod("glBindFramebuffer");
        incrementMethod("glBindFramebuffer");
    ...
    public void glBindRenderbuffer(int target, int renderbuffer) {
        calls++;
        incrementMethod("glBindRenderbuffer");
        incrementMethod("glBindRenderbuffer");
    ...
    public void glBlendEquation(int mode) {
        calls++;
        incrementMethod("glBlendEquation");
        incrementMethod("glBlendEquation");
    ...
    public void glBlendEquationSeparate(int modeRGB, int modeAlpha) {
        calls++;
        incrementMethod("glBlendEquationSeparate");
        incrementMethod("glBlendEquationSeparate");
    ...
    public void glBlendFuncSeparate(int srcRGB, int dstRGB, int srcAlpha, int dstAlpha) {
        calls++;
        incrementMethod("glBlendFuncSeparate");
        incrementMethod("glBlendFuncSeparate");
    ...
    public void glBufferSubData(int target, int offset, int size, Buffer data) {
        calls++;
        incrementMethod("glBufferSubData");
        incrementMethod("glBufferSubData");
    ...
    public void glCompileShader(int shader) {
        calls++;
        incrementMethod("glCompileShader");
        incrementMethod("glCompileShader");
    ...
    public void glDeleteBuffer(int buffer) {
        calls++;
        incrementMethod("glDeleteBuffer");
        incrementMethod("glDeleteBuffer");
    ...
    public void glDeleteBuffers(int n, IntBuffer buffers) {
        calls++;
        incrementMethod("glDeleteBuffers");
        incrementMethod("glDeleteBuffers");
    ...
    public void glDeleteFramebuffer(int framebuffer) {
        calls++;
        incrementMethod("glDeleteFramebuffer");
        incrementMethod("glDeleteFramebuffer");
    ...
    public void glDeleteFramebuffers(int n, IntBuffer framebuffers) {
        calls++;
        incrementMethod("glDeleteFramebuffers");
        incrementMethod("glDeleteFramebuffers");
    ...
    public void glDeleteProgram(int program) {
        calls++;
        incrementMethod("glDeleteProgram");
        incrementMethod("glDeleteProgram");
    ...
    public void glDeleteRenderbuffer(int renderbuffer) {
        calls++;
        incrementMethod("glDeleteRenderbuffer");
        incrementMethod("glDeleteRenderbuffer");
    ...
    public void glDeleteRenderbuffers(int n, IntBuffer renderbuffers) {
        calls++;
        incrementMethod("glDeleteRenderbuffers");
        incrementMethod("glDeleteRenderbuffers");
    ...
    public void glDeleteShader(int shader) {
        calls++;
        incrementMethod("glDeleteShader");
        incrementMethod("glDeleteShader");
    ...
    public void glDetachShader(int program, int shader) {
        calls++;
        incrementMethod("glDetachShader");
        incrementMethod("glDetachShader");
    ...
    public void glDisableVertexAttribArray(int index) {
        calls++;
        incrementMethod("glDisableVertexAttribArray");
        incrementMethod("glDisableVertexAttribArray");
    ...
    public void glEnableVertexAttribArray(int index) {
        calls++;
        incrementMethod("glEnableVertexAttribArray");
        incrementMethod("glEnableVertexAttribArray");
    ...
    public void glFramebufferRenderbuffer(int target, int attachment, int renderbuffertarget, int renderbuffer) {
        calls++;
        incrementMethod("glFramebufferRenderbuffer");
        incrementMethod("glFramebufferRenderbuffer");
    ...
    public void glFramebufferTexture2D(int target, int attachment, int textarget, int texture, int level) {
        calls++;
        incrementMethod("glFramebufferTexture2D");
        incrementMethod("glFramebufferTexture2D");
    ...
    public void glGenerateMipmap(int target) {
        calls++;
        incrementMethod("glGenerateMipmap");
        incrementMethod("glGenerateMipmap");
    ...
    public void glGenFramebuffers(int n, IntBuffer framebuffers) {
        calls++;
        incrementMethod("glGenFramebuffers");
        incrementMethod("glGenFramebuffers");
    ...
    public void glGenRenderbuffers(int n, IntBuffer renderbuffers) {
        calls++;
        incrementMethod("glGenRenderbuffers");
        incrementMethod("glGenRenderbuffers");
    ...
    public void glGetAttachedShaders(int program, int maxcount, Buffer count, IntBuffer shaders) {
        calls++;
        incrementMethod("glGetAttachedShaders");
        incrementMethod("glGetAttachedShaders");
    ...
    public void glGetBufferParameteriv(int target, int pname, IntBuffer params) {
        calls++;
        incrementMethod("glGetBufferParameteriv");
        incrementMethod("glGetBufferParameteriv");
    ...
    public void glGetFramebufferAttachmentParameteriv(int target, int attachment, int pname, IntBuffer params) {
        calls++;
        incrementMethod("glGetFramebufferAttachmentParameteriv");
        incrementMethod("glGetFramebufferAttachmentParameteriv");
    ...
    public void glGetProgramiv(int program, int pname, IntBuffer params) {
        calls++;
        incrementMethod("glGetProgramiv");
        incrementMethod("glGetProgramiv");
    ...
    public void glGetRenderbufferParameteriv(int target, int pname, IntBuffer params) {
        calls++;
        incrementMethod("glGetRenderbufferParameteriv");
        incrementMethod("glGetRenderbufferParameteriv");
    ...
    public void glGetShaderPrecisionFormat(int shadertype, int precisiontype, IntBuffer range, IntBuffer precision) {
        calls++;
        incrementMethod("glGetShaderPrecisionFormat");
        incrementMethod("glGetShaderPrecisionFormat");
    ...
    public void glGetTexParameterfv(int target, int pname, FloatBuffer params) {
        calls++;
        incrementMethod("glGetTexParameterfv");
        incrementMethod("glGetTexParameterfv");
    ...
    public void glGetTexParameteriv(int target, int pname, IntBuffer params) {
        calls++;
        incrementMethod("glGetTexParameteriv");
        incrementMethod("glGetTexParameteriv");
    ...
    public void glGetUniformfv(int program, int location, FloatBuffer params) {
        calls++;
        incrementMethod("glGetUniformfv");
        incrementMethod("glGetUniformfv");
    ...
    public void glGetUniformiv(int program, int location, IntBuffer params) {
        calls++;
        incrementMethod("glGetUniformiv");
        incrementMethod("glGetUniformiv");
    ...
    public void glGetVertexAttribfv(int index, int pname, FloatBuffer params) {
        calls++;
        incrementMethod("glGetVertexAttribfv");
        incrementMethod("glGetVertexAttribfv");
    ...
    public void glGetVertexAttribiv(int index, int pname, IntBuffer params) {
        calls++;
        incrementMethod("glGetVertexAttribiv");
        incrementMethod("glGetVertexAttribiv");
    ...
    public void glGetVertexAttribPointerv(int index, int pname, Buffer pointer) {
        calls++;
        incrementMethod("glGetVertexAttribPointerv");
        incrementMethod("glGetVertexAttribPointerv");
    ...
    public void glReleaseShaderCompiler() {
        calls++;
        incrementMethod("glReleaseShaderCompiler");
        incrementMethod("glReleaseShaderCompiler");
    ...
    public void glRenderbufferStorage(int target, int internalformat, int width, int height) {
        calls++;
        incrementMethod("glRenderbufferStorage");
        incrementMethod("glRenderbufferStorage");
    ...
    public void glSampleCoverage(float value, boolean invert) {
        calls++;
        incrementMethod("glSampleCoverage");
        incrementMethod("glSampleCoverage");
    ...
    public void glShaderBinary(int n, IntBuffer shaders, int binaryformat, Buffer binary, int length) {
        calls++;
        incrementMethod("glShaderBinary");
        incrementMethod("glShaderBinary");
    ...
    public void glShaderSource(int shader, String string) {
        calls++;
        incrementMethod("glShaderSource");
        incrementMethod("glShaderSource");
    ...
    public void glStencilFuncSeparate(int face, int func, int ref, int mask) {
        calls++;
        incrementMethod("glStencilFuncSeparate");
        incrementMethod("glStencilFuncSeparate");
    ...
    public void glStencilMaskSeparate(int face, int mask) {
        calls++;
        incrementMethod("glStencilMaskSeparate");
        incrementMethod("glStencilMaskSeparate");
    ...
    public void glStencilOpSeparate(int face, int fail, int zfail, int zpass) {
        calls++;
        incrementMethod("glStencilOpSeparate");
        incrementMethod("glStencilOpSeparate");
    ...
    public void glTexParameterfv(int target, int pname, FloatBuffer params) {
        calls++;
        incrementMethod("glTexParameterfv");
        incrementMethod("glTexParameterfv");
    ...
    public void glTexParameteri(int target, int pname, int param) {
        calls++;
        incrementMethod("glTexParameteri");
        incrementMethod("glTexParameteri");
    ...
    public void glTexParameteriv(int target, int pname, IntBuffer params) {
        calls++;
        incrementMethod("glTexParameteriv");
        incrementMethod("glTexParameteriv");
    ...
    public void glUniformMatrix2fv(int location, int count, boolean transpose, FloatBuffer value) {
        calls++;
        incrementMethod("glUniformMatrix2fv");
        incrementMethod("glUniformMatrix2fv");
    ...
    public void glUniformMatrix3fv(int location, int count, boolean transpose, FloatBuffer value) {
        calls++;
        incrementMethod("glUniformMatrix3fv");
        incrementMethod("glUniformMatrix3fv");
    ...
    public void glUniformMatrix4fv(int location, int count, boolean transpose, FloatBuffer value) {
        calls++;
        incrementMethod("glUniformMatrix4fv");
        incrementMethod("glUniformMatrix4fv");
    ...
    public void glValidateProgram(int program) {
        calls++;
        incrementMethod("glValidateProgram");
        incrementMethod("glValidateProgram");
    ...
    public void glVertexAttrib1f(int indx, float x) {
        calls++;
        incrementMethod("glVertexAttrib1f");
        incrementMethod("glVertexAttrib1f");
    ...
    public void glVertexAttrib1fv(int indx, FloatBuffer values) {
        calls++;
        incrementMethod("glVertexAttrib1fv");
        incrementMethod("glVertexAttrib1fv");
    ...
    public void glVertexAttrib2f(int indx, float x, float y) {
        calls++;
        incrementMethod("glVertexAttrib2f");
        incrementMethod("glVertexAttrib2f");
    ...
    public void glVertexAttrib2fv(int indx, FloatBuffer values) {
        calls++;
        incrementMethod("glVertexAttrib2fv");
        incrementMethod("glVertexAttrib2fv");
    ...
    public void glVertexAttrib3f(int indx, float x, float y, float z) {
        calls++;
        incrementMethod("glVertexAttrib3f");
        incrementMethod("glVertexAttrib3f");
    ...
    public void glVertexAttrib3fv(int indx, FloatBuffer values) {
        calls++;
        incrementMethod("glVertexAttrib3fv");
        incrementMethod("glVertexAttrib3fv");
    ...
    public void glVertexAttrib4f(int indx, float x, float y, float z, float w) {
        calls++;
        incrementMethod("glVertexAttrib4f");
        incrementMethod("glVertexAttrib4f");
    ...
    public void glVertexAttrib4fv(int indx, FloatBuffer values) {
        calls++;
        incrementMethod("glVertexAttrib4fv");
        incrementMethod("glVertexAttrib4fv");
    ...
    public void glVertexAttribPointer(int indx, int size, int type, boolean normalized, int stride, Buffer ptr) {
        calls++;
        incrementMethod("glVertexAttribPointer");
        incrementMethod("glVertexAttribPointer");
    ...
    public void glDrawRangeElements(int mode, int start, int end, int count, int type, Buffer indices) {
        vertexCount.put(count);
        drawCalls++;
        incrementMethod("glDrawRangeElements");
        incrementMethod("glDrawRangeElements");
        calls++;
        incrementMethod("glDrawRangeElements");
        incrementMethod("glDrawRangeElements");
    ...
    public void glTexSubImage3D(int target, int level, int xoffset, int yoffset, int zoffset, int width, int height, int depth,
        ...
        calls++;
        incrementMethod("glTexSubImage3D");
        incrementMethod("glTexSubImage3D");
    ...
    public void glCopyTexSubImage3D(int target, int level, int xoffset, int yoffset, int zoffset, int x, int y, int width,
                                    int height) {
        calls++;
        incrementMethod("glCopyTexSubImage3D");
        incrementMethod("glCopyTexSubImage3D");
    ...
    public void glDeleteQueries(int n, int[] ids, int offset) {
        calls++;
        incrementMethod("glDeleteQueries");
        incrementMethod("glDeleteQueries");
    ...
    public void glGetQueryObjectuiv(int id, int pname, IntBuffer params) {
        calls++;
        incrementMethod("glGetQueryObjectuiv");
        incrementMethod("glGetQueryObjectuiv");
    ...
    public void glUniformMatrix2x3fv(int location, int count, boolean transpose, FloatBuffer value) {
        calls++;
        incrementMethod("glUniformMatrix2x3fv");
        incrementMethod("glUniformMatrix2x3fv");
    ...
    public void glUniformMatrix3x2fv(int location, int count, boolean transpose, FloatBuffer value) {
        calls++;
        incrementMethod("glUniformMatrix3x2fv");
        incrementMethod("glUniformMatrix3x2fv");
    ...
    public void glUniformMatrix2x4fv(int location, int count, boolean transpose, FloatBuffer value) {
        calls++;
        incrementMethod("glUniformMatrix2x4fv");
        incrementMethod("glUniformMatrix2x4fv");
    ...
    public void glUniformMatrix4x2fv(int location, int count, boolean transpose, FloatBuffer value) {
        calls++;
        incrementMethod("glUniformMatrix4x2fv");
        incrementMethod("glUniformMatrix4x2fv");
    ...
    public void glUniformMatrix3x4fv(int location, int count, boolean transpose, FloatBuffer value) {
        calls++;
        incrementMethod("glUniformMatrix3x4fv");
        incrementMethod("glUniformMatrix3x4fv");
    ...
    public void glUniformMatrix4x3fv(int location, int count, boolean transpose, FloatBuffer value) {
        calls++;
        incrementMethod("glUniformMatrix4x3fv");
        incrementMethod("glUniformMatrix4x3fv");
    ...
    public void glBlitFramebuffer(int srcX0, int srcY0, int srcX1, int srcY1, int dstX0, int dstY0, int dstX1, int dstY1,
                                  int mask, int filter) {
        calls++;
        incrementMethod("glBlitFramebuffer");
        incrementMethod("glBlitFramebuffer");
    ...
    public void glRenderbufferStorageMultisample(int target, int samples, int internalformat, int width, int height) {
        calls++;
        incrementMethod("glRenderbufferStorageMultisample");
        incrementMethod("glRenderbufferStorageMultisample");
    ...
    public void glFramebufferTextureLayer(int target, int attachment, int texture, int level, int layer) {
        calls++;
        incrementMethod("glFramebufferTextureLayer");
        incrementMethod("glFramebufferTextureLayer");
    ...
    public void glFlushMappedBufferRange(int target, int offset, int length) {
        calls++;
        incrementMethod("glFlushMappedBufferRange");
        incrementMethod("glFlushMappedBufferRange");
    ...
    public void glBindVertexArray(int array) {
        calls++;
        incrementMethod("glBindVertexArray");
        incrementMethod("glBindVertexArray");
    ...
    public void glDeleteVertexArrays(int n, int[] arrays, int offset) {
        calls++;
        incrementMethod("glDeleteVertexArrays");
        incrementMethod("glDeleteVertexArrays");
    ...
    public void glGenVertexArrays(int n, int[] arrays, int offset) {
        calls++;
        incrementMethod("glGenVertexArrays");
        incrementMethod("glGenVertexArrays");
    ...
    public void glBeginTransformFeedback(int primitiveMode) {
        calls++;
        incrementMethod("glBeginTransformFeedback");
        incrementMethod("glBeginTransformFeedback");
    ...
    public void glEndTransformFeedback() {
        calls++;
        incrementMethod("glEndTransformFeedback");
        incrementMethod("glEndTransformFeedback");
    ...
    public void glBindBufferRange(int target, int index, int buffer, int offset, int size) {
        calls++;
        incrementMethod("glBindBufferRange");
        incrementMethod("glBindBufferRange");
    ...
    public void glBindBufferBase(int target, int index, int buffer) {
        calls++;
        incrementMethod("glBindBufferBase");
        incrementMethod("glBindBufferBase");
    ...
    public void glTransformFeedbackVaryings(int program, String[] varyings, int bufferMode) {
        calls++;
        incrementMethod("glTransformFeedbackVaryings");
        incrementMethod("glTransformFeedbackVaryings");
    ...
    public void glVertexAttribIPointer(int index, int size, int type, int stride, int offset) {
        calls++;
        incrementMethod("glVertexAttribIPointer");
        incrementMethod("glVertexAttribIPointer");
    ...
    public void glGetVertexAttribIiv(int index, int pname, IntBuffer params) {
        calls++;
        incrementMethod("glGetVertexAttribIiv");
        incrementMethod("glGetVertexAttribIiv");
    ...
    public void glGetVertexAttribIuiv(int index, int pname, IntBuffer params) {
        calls++;
        incrementMethod("glGetVertexAttribIuiv");
        incrementMethod("glGetVertexAttribIuiv");
    ...
    public void glVertexAttribI4i(int index, int x, int y, int z, int w) {
        calls++;
        incrementMethod("glVertexAttribI4i");
        incrementMethod("glVertexAttribI4i");
    ...
    public void glVertexAttribI4ui(int index, int x, int y, int z, int w) {
        calls++;
        incrementMethod("glVertexAttribI4ui");
        incrementMethod("glVertexAttribI4ui");
    ...
    public void glGetUniformuiv(int program, int location, IntBuffer params) {
        calls++;
        incrementMethod("glGetUniformuiv");
        incrementMethod("glGetUniformuiv");
    ...
    public void glClearBufferiv(int buffer, int drawbuffer, IntBuffer value) {
        calls++;
        incrementMethod("glClearBufferiv");
        incrementMethod("glClearBufferiv");
    ...
    public void glClearBufferuiv(int buffer, int drawbuffer, IntBuffer value) {
        calls++;
        incrementMethod("glClearBufferuiv");
        incrementMethod("glClearBufferuiv");
    ...
    public void glClearBufferfv(int buffer, int drawbuffer, FloatBuffer value) {
        calls++;
        incrementMethod("glClearBufferfv");
        incrementMethod("glClearBufferfv");
    ...
    public void glClearBufferfi(int buffer, int drawbuffer, float depth, int stencil) {
        calls++;
        incrementMethod("glClearBufferfi");
        incrementMethod("glClearBufferfi");
    ...
    public void glCopyBufferSubData(int readTarget, int writeTarget, int readOffset, int writeOffset, int size) {
        calls++;
        incrementMethod("glCopyBufferSubData");
        incrementMethod("glCopyBufferSubData");
    ...
    public void glGetUniformIndices(int program, String[] uniformNames, IntBuffer uniformIndices) {
        calls++;
        incrementMethod("glGetUniformIndices");
        incrementMethod("glGetUniformIndices");
    ...
    public void glGetActiveUniformsiv(int program, int uniformCount, IntBuffer uniformIndices, int pname, IntBuffer params) {
        calls++;
        incrementMethod("glGetActiveUniformsiv");
        incrementMethod("glGetActiveUniformsiv");
    ...
    public void glGetActiveUniformBlockiv(int program, int uniformBlockIndex, int pname, IntBuffer params) {
        calls++;
        incrementMethod("glGetActiveUniformBlockiv");
        incrementMethod("glGetActiveUniformBlockiv");
    ...
    public void glGetActiveUniformBlockName(int program, int uniformBlockIndex, Buffer length, Buffer uniformBlockName) {
        calls++;
        incrementMethod("glGetActiveUniformBlockName");
        incrementMethod("glGetActiveUniformBlockName");
    ...
    public void glUniformBlockBinding(int program, int uniformBlockIndex, int uniformBlockBinding) {
        calls++;
        incrementMethod("glUniformBlockBinding");
        incrementMethod("glUniformBlockBinding");
    ...
    public void glDrawArraysInstanced(int mode, int first, int count, int instanceCount) {
        vertexCount.put(count);
        drawCalls++;
        incrementMethod("glDrawArraysInstanced");
        incrementMethod("glDrawArraysInstanced");
        calls++;
        incrementMethod("glDrawArraysInstanced");
        incrementMethod("glDrawArraysInstanced");
    ...
    public void glDrawElementsInstanced(int mode, int count, int type, int indicesOffset, int instanceCount) {
        vertexCount.put(count);
        drawCalls++;
        incrementMethod("glDrawElementsInstanced");
        incrementMethod("glDrawElementsInstanced");
        calls++;
        incrementMethod("glDrawElementsInstanced");
        incrementMethod("glDrawElementsInstanced");
    ...
    public void glGetInteger64v(int pname, LongBuffer params) {
        calls++;
        incrementMethod("glGetInteger64v");
        incrementMethod("glGetInteger64v");
    ...
    public void glGetBufferParameteri64v(int target, int pname, LongBuffer params) {
        calls++;
        incrementMethod("glGetBufferParameteri64v");
        incrementMethod("glGetBufferParameteri64v");
    ...
    public void glDeleteSamplers(int count, int[] samplers, int offset) {
        calls++;
        incrementMethod("glDeleteSamplers");
        incrementMethod("glDeleteSamplers");
    ...
    public void glSamplerParameteri(int sampler, int pname, int param) {
        calls++;
        incrementMethod("glSamplerParameteri");
        incrementMethod("glSamplerParameteri");
    ...
    public void glSamplerParameteriv(int sampler, int pname, IntBuffer param) {
        calls++;
        incrementMethod("glSamplerParameteriv");
        incrementMethod("glSamplerParameteriv");
    ...
    public void glSamplerParameterf(int sampler, int pname, float param) {
        calls++;
        incrementMethod("glSamplerParameterf");
        incrementMethod("glSamplerParameterf");
    ...
    public void glSamplerParameterfv(int sampler, int pname, FloatBuffer param) {
        calls++;
        incrementMethod("glSamplerParameterfv");
        incrementMethod("glSamplerParameterfv");
    ...
    public void glGetSamplerParameteriv(int sampler, int pname, IntBuffer params) {
        calls++;
        incrementMethod("glGetSamplerParameteriv");
        incrementMethod("glGetSamplerParameteriv");
    ...
    public void glGetSamplerParameterfv(int sampler, int pname, FloatBuffer params) {
        calls++;
        incrementMethod("glGetSamplerParameterfv");
        incrementMethod("glGetSamplerParameterfv");
    ...
    public void glVertexAttribDivisor(int index, int divisor) {
        calls++;
        incrementMethod("glVertexAttribDivisor");
        incrementMethod("glVertexAttribDivisor");
    ...
    public void glBindTransformFeedback(int target, int id) {
        calls++;
        incrementMethod("glBindTransformFeedback");
        incrementMethod("glBindTransformFeedback");
    ...
    public void glDeleteTransformFeedbacks(int n, int[] ids, int offset) {
        calls++;
        incrementMethod("glDeleteTransformFeedbacks");
        incrementMethod("glDeleteTransformFeedbacks");
    ...
    public void glGenTransformFeedbacks(int n, int[] ids, int offset) {
        calls++;
        incrementMethod("glGenTransformFeedbacks");
        incrementMethod("glGenTransformFeedbacks");
    ...
    public void glPauseTransformFeedback() {
        calls++;
        incrementMethod("glPauseTransformFeedback");
        incrementMethod("glPauseTransformFeedback");
    ...
    public void glResumeTransformFeedback() {
        calls++;
        incrementMethod("glResumeTransformFeedback");
        incrementMethod("glResumeTransformFeedback");
    ...
    public void glProgramParameteri(int program, int pname, int value) {
        calls++;
        incrementMethod("glProgramParameteri");
        incrementMethod("glProgramParameteri");
    ...
    public void glInvalidateFramebuffer(int target, int numAttachments, IntBuffer attachments) {
        calls++;
        incrementMethod("glInvalidateFramebuffer");
        incrementMethod("glInvalidateFramebuffer");
    ...
    public void glInvalidateSubFramebuffer(int target, int numAttachments, IntBuffer attachments, int x, int y, int width,
                                           int height) {
        calls++;
        incrementMethod("glInvalidateSubFramebuffer");
        incrementMethod("glInvalidateSubFramebuffer");
