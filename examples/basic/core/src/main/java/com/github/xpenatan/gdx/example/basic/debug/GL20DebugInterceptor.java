...
class GL20DebugInterceptor extends GLDebugInterceptor implements GL20 {

    protected final GL20 gl20;

    public GL20DebugInterceptor(GLDebugProfiler glProfiler, GL20 gl20) {
        super(glProfiler);
        this.gl20 = gl20;
    }
    ...
    public int glCheckFramebufferStatus(int target) {
        calls++;
        incrementMethod("glCheckFramebufferStatus");
    ...
    public int glCreateProgram() {
        calls++;
        incrementMethod("glCreateProgram");
    ...
    public int glCreateShader(int type) {
        calls++;
        incrementMethod("glCreateShader");
    ...
    public int glGenFramebuffer() {
        calls++;
        incrementMethod("glGenFramebuffer");
    ...
    public int glGenRenderbuffer() {
        calls++;
        incrementMethod("glGenRenderbuffer");
    ...
    public String glGetActiveAttrib(int program, int index, IntBuffer size, IntBuffer type) {
        calls++;
        incrementMethod("glGetActiveAttrib");
    ...
    public String glGetActiveUniform(int program, int index, IntBuffer size, IntBuffer type) {
        calls++;
        incrementMethod("glGetActiveUniform");
    ...
    public int glGetAttribLocation(int program, String name) {
        calls++;
        incrementMethod("glGetAttribLocation");
    ...
    public String glGetProgramInfoLog(int program) {
        calls++;
        incrementMethod("glGetProgramInfoLog");
    ...
    public String glGetShaderInfoLog(int shader) {
        calls++;
        incrementMethod("glGetShaderInfoLog");
    ...
    public int glGetUniformLocation(int program, String name) {
        calls++;
        incrementMethod("glGetUniformLocation");
    ...
    public boolean glIsFramebuffer(int framebuffer) {
        calls++;
        incrementMethod("glIsFramebuffer");
    ...
    public boolean glIsRenderbuffer(int renderbuffer) {
        calls++;
        incrementMethod("glIsRenderbuffer");
