...
val buildDesktopCDebug = tasks.register<JavaExec>("freetype_desktop_c_debug_build") {
    group = desktopCTaskGroup
...
tasks.register("freetype_desktop_c_build") {
    group = desktopCTaskGroup
    description = "Compatibility alias for freetype_desktop_c_debug_build"
